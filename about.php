...
<body style="background-image:linear-gradient(rgb(255, 77, 45),rgb(156, 17, 22))">
  <?php include "connectionfiles/_nev.php"?>
    <div class="container">
        <divb class="row">
            <div class="col-lg-4 col-md-4 col-12">
             <h1 class="info  text-white">OWNER-<i class="fa-solid fa-user"></i></h1>   
            <div class="card" style="width:18rem;">
                <img src="jobsdata/ownerimages/person.jpg" class="card-img-top" alt="person">
                <div class="card-body">
            ...
            <div class="col-lg-4 col-md-4 col-12">
            <h1 class="info text-white">MANEGER-<i class="fa-solid fa-user"></i></h1>
            <div class="card" style="width:18rem;">
                <img src="jobsdata/ownerimages/person.jpg" class="card-img-top" alt="person">
                <div class="card-body">
            ...
            <div class="col-lg-4 col-md-4 col-4">
                <div class=""> 
                   ...
                   <a href="#" class="btn mt-5 text-white bg-dark">LOGEOUT</a>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="staff text-center text-white">KICHAN STAFF-INFO-<i class="fa-solid fa-user"></i></h1>
            </div>
        </div>
    </div> 
    <br>
